...
return [
    ...
    */
    ...
    'connections' => [
        ...
        //settingan untuk rabbit mq jenis fanout
        'rabbitmq' => [
        ...
        //settingan untuk rabbit mq yang direct
        'rabbitmq_direct' => [
            ...
            'options' => [
                ...
                'exchange' => [
                    ...
                    'durable' => env('RABBITMQ_EXCHANGE_DURABLE_DIRECT', true),
                    'auto_delete' => env('RABBITMQ_EXCHANGE_AUTODELETE_DIRECT', false),
                    'arguments' => env('RABBITMQ_EXCHANGE_ARGUMENTS_DIRECT'),
                ],
            ],
